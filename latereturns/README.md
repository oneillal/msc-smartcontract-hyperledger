...
# Accord Protocol Template: latereturns
...
```
cicero parse --template ./latereturns/ --dsl ./latereturns/sample.txt
...
data.json:
{
   "$class": "org.dublincoco.libraries.contracts.MyRequest",
   "input": "World"
}
```

```
cicero execute --template ./latereturns/ --dsl ./latereturns/sample.txt --data ./latereturns/data.json 
```
...
```
{
   ...
   "request":{
      "$class":"org.dublincoco.libraries.contracts.Request",
      "input":"World"
   },
   "response":{
      "$class":"org.dublincoco.libraries.contracts.Response",
