...
class TemplateInstance {
  ...
  parse(input, currentTime, fileName) {
    ...
    this.parserManager.setCurrentTime(currentTime); // Parse
  ...
  draft(options, currentTime) {
    ...
    this.parserManager.setCurrentTime(currentTime); // Draft
  ...
  static ciceroFormulaEval(logicManager, clauseId, ergoEngine, name) {
    return (code, data, currentTime) => {
      const result = ergoEngine.calculate(logicManager, clauseId, name, data, currentTime, {}); // console.log('Formula result: ' + JSON.stringify(result.response));
